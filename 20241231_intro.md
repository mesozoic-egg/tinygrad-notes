...
One part we briefly touched upon is `NOOPT=1` flag, it disables some default optimization. Recall that our addition example
would convert the 16 grids launch configuration into 4 grid with vectorized data to speed up compute. This
