...
concerns how weights and updated, how neurons are represented as tensors and matrix multiplication. This part is
...
Let's use the simpliest computation example, where we are multiplying two tensors element-wise:
